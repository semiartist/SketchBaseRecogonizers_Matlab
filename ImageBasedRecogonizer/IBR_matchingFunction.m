function result = IBR_matchingFunction(Graph, resolution, tempInd)
...
% numTemp = size(template,3);  %% MODIFIED FOR ROTATED GRAPH
...
currentTemp = IBR_removeZero(graphTemplate(:,:,tempInd));
...
% tanimoto(runner,1) = alpha*taniBlack + (1-alpha)*taniWhite; %% REPLACED
% WITH BELOW FUNCTION AS ROTATE THE GRAPH;
